...
class CycleDecision:
    ...
    # LLM-suggested clean encounter names per cycle number (e.g., {"2": "Cycle 2 Day 1"})
    suggested_encounter_names: Optional[Dict[str, str]] = None
    # LLM-computed absolute study day for non-expanded encounters (e.g., Screening = -28)
    absolute_study_day: Optional[int] = None
    # LLM-computed absolute study days per cycle for expanded encounters (e.g., {"2": 22, "3": 43})
    absolute_study_days: Optional[Dict[str, int]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "suggestedEncounterNames": self.suggested_encounter_names,
            "absoluteStudyDay": self.absolute_study_day,
            "absoluteStudyDays": self.absolute_study_days,
        }
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "CycleDecision":
        ...
        return cls(
            ...
            suggested_encounter_names=data.get("suggestedEncounterNames"),
            absolute_study_day=data.get("absoluteStudyDay"),
            absolute_study_days=data.get("absoluteStudyDays"),
        )
