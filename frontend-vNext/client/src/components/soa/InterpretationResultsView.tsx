                ...
                <div className="rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 p-6 text-white shadow-lg">
                  <div className="flex items-center justify-between">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-6 py-3 text-base font-semibold text-blue-600 bg-white rounded-xl hover:bg-blue-50 shadow-md hover:shadow-lg transition-all flex-shrink-0"
                    >
