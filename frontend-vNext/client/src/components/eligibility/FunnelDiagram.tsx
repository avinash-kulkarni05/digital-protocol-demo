    ...
    <div className="space-y-4">
      ...
      <div className="relative space-y-1">
        ...
        {sortedStages.map((stage, index) => {
          ...
          const getBarColor = () => {
            if (remainingPercent > 70) return "bg-emerald-500";
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 h-6 bg-gray-100 rounded-full overflow-hidden relative">
                ...
                {eliminationRate > 0 && (
                  <div
                    className="absolute top-0 right-0 h-full bg-red-200/50 rounded-r-full flex items-center justify-center"
        ...
        <div className="flex items-center gap-2 mt-2 pt-2 border-t border-gray-100">
          ...
          <span className="text-xs text-blue-600 font-bold whitespace-nowrap w-16 text-right">
            ...
            <div>
              ...
              <div className="space-y-1">
                {killerQebs.slice(0, 3).map(qeb => (
                  ...
                  >
                    <span className="text-amber-800 font-medium truncate flex-1 mr-2">
    ...
    <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="text-center p-2 bg-emerald-50 rounded-lg">
          <div className="text-lg font-bold text-emerald-700">{queryablePercent}%</div>
          <div className="text-[10px] text-emerald-600">Query-Ready</div>
        </div>
        ...
        <div className="text-center p-2 bg-amber-50 rounded-lg">
          <div className="text-lg font-bold text-amber-700">{killerCount}</div>
          <div className="text-[10px] text-amber-600">High Impact</div>
        </div>
      </div>
        ...
        <div className="pt-2 border-t border-gray-100">
          ...
          <div className="space-y-1">
            {topEliminationFactors.slice(0, 3).map((factor, idx) => (
              ...
              >
                <span className="w-4 h-4 rounded-full bg-red-100 text-red-600 flex items-center justify-center text-[9px] font-semibold">
                  {idx + 1}
                </span>
