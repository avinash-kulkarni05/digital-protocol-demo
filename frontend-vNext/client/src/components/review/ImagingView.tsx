        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {criteria.criteria_version && (
            <div className="p-3 bg-white rounded-lg border border-gray-200">
              <span className="text-xs font-medium text-gray-700 uppercase block mb-1">Version</span>
              <EditableText
      ...
      <div className="bg-gradient-to-br from-gray-50 to-gray-50 border border-gray-200 rounded-2xl p-5">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="font-bold text-gray-900 text-lg">Blinded Independent Central Review</h4>
