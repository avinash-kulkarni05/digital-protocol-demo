                ...
                {condition.trigger_threshold && (
                  <div className="p-3 bg-gray-50 border border-gray-200 rounded-lg">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-xs font-medium text-gray-800 uppercase">Trigger Threshold</span>
                    </div>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-xl p-5">
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="font-bold text-gray-900">Dose Modification Levels</h4>
              <div className="flex items-center gap-2 mt-1">
          ...
          {doseInfo.minimum_dose && (
            <div className="p-3 bg-white rounded-lg border border-gray-200">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs font-medium text-gray-700 uppercase">Minimum Dose</span>
              </div>
              <div className="text-sm text-gray-900">
                <EditableText
          ...
          {doseInfo.re_escalation_criteria && (
            <div className="p-3 bg-white rounded-lg border border-gray-200">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs font-medium text-gray-700 uppercase">Re-escalation Criteria</span>
              </div>
              <div className="text-sm text-gray-900">
                <EditableText
                  ...
                  <tr key={level.level_id || idx} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3">
                      {level.dose_percentage !== undefined && level.dose_percentage !== null ? (
                        <span className="inline-flex items-center gap-1 px-2 py-1 text-sm font-medium bg-gray-100 text-gray-700 rounded">
                ...
                {adjustment.adjustment_trigger && (
                  <div className="p-3 bg-gray-50 border border-gray-200 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      <AlertTriangle className="w-4 h-4 text-gray-600" />
                      <span className="text-xs font-semibold text-gray-800 uppercase">Trigger</span>
                    </div>
                    <div className="text-sm text-gray-900">
                      <EditableText
                ...
                {adjustment.adjustment_action && (
                  <div className="p-3 bg-gray-50 border border-gray-200 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs font-semibold text-gray-800 uppercase">Action</span>
                    </div>
                    <div className="text-sm text-gray-900">
                      <EditableText
