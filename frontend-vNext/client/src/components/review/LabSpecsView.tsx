                ...
                <div className="p-2 bg-purple-50 rounded-lg border border-purple-200">
                  ...
                  <div className="flex flex-wrap gap-2 text-xs">
                    {panel.biomedicalConcept.code && (
                      <span className="bg-white px-2 py-1 rounded border border-purple-200">Code: {panel.biomedicalConcept.code}</span>
                    )}
                    {panel.biomedicalConcept.decode && (
                      <span className="bg-white px-2 py-1 rounded border border-purple-200">{panel.biomedicalConcept.decode}</span>
                    )}
                  </div>
                </div>
              )}
      ...
      >
        ...
        <div className="flex items-center gap-2">
          {test.fasting_required && (
            <span className="text-xs bg-amber-50 text-amber-700 px-2 py-0.5 rounded-full border border-amber-200">Fasting</span>
          )}
            ...
            <div className="px-4 pb-4 border-t border-gray-100 pt-3 space-y-4">
              ...
              {test.reference_ranges?.length > 0 && (
                <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
                  <span className="text-xs font-medium text-blue-700 uppercase tracking-wider block mb-2">Reference Ranges</span>
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            ...
            {biomarkerSamples.optional_consent_required !== undefined && (
              <div className="bg-gray-50 rounded-lg p-3">
                ...
                <span className={cn("text-sm font-medium", biomarkerSamples.optional_consent_required ? "text-amber-700" : "text-gray-900")}>
