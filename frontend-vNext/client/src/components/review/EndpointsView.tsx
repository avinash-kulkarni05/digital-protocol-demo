        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1 flex-wrap">
            ...
            {analysis.forest_plot !== undefined && (
              <span className={cn(
                "text-xs px-2 py-0.5 rounded-full",
                analysis.forest_plot ? "bg-blue-50 text-blue-700" : "bg-gray-100 text-gray-600"
              )}>
                ...
                <div className="bg-white rounded-lg p-3 border border-gray-100">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    {estimand.treatment.comparator_arm && (
                      <div className="bg-gray-50 rounded-lg p-2">
                        <span className="text-xs font-medium text-blue-700 uppercase">Comparator Arm</span>
                  ...
                  <div className="bg-white rounded-lg p-3 border border-gray-100">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {population.is_sensitivity_for_endpoints.map((epId: string, idx: number) => (
                        <span key={idx} className="text-xs bg-blue-50 text-blue-700 px-2 py-1 rounded-full font-mono">
                          {epId}
                        </span>
                      ))}
                    </div>
