      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-5">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="font-bold text-blue-900 text-lg">Monitoring Plan</h4>
              {plan.monitoring_approach && (
                <span className="inline-flex items-center px-2 py-1 text-xs font-medium bg-blue-100 text-blue-700 rounded mt-1">
                  <EditableText
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
            {plan.routine_monitoring.frequency && (
              <div className="p-3 bg-blue-50 rounded-lg">
                <span className="text-xs font-medium text-blue-700 uppercase block mb-1">Frequency</span>
            ...
            {plan.routine_monitoring.visit_type && (
              <div className="p-3 bg-blue-50 rounded-lg">
                <span className="text-xs font-medium text-blue-700 uppercase block mb-1">Visit Type</span>
                <span className="font-medium text-blue-900">
                  <EditableText
            ...
            {plan.routine_monitoring.sdv_percentage !== undefined && (
              <div className="p-3 bg-purple-50 rounded-lg">
                <span className="text-xs font-medium text-purple-700 uppercase block mb-1">SDV %</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {plan.triggered_monitoring.response_timeline && (
              <div className="p-3 bg-amber-50 rounded-lg">
                <span className="text-xs font-medium text-amber-700 uppercase block mb-1">Response Timeline</span>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
            {reg.informed_consent.consent_type && (
              <div className="p-3 bg-purple-50 rounded-lg">
                <span className="text-xs font-medium text-purple-700 uppercase block mb-1">Consent Type</span>
                <span className="font-medium text-purple-900">{reg.informed_consent.consent_type}</span>
              </div>
            )}
            ...
            <div className="mb-3">
              ...
              <div className="flex flex-wrap gap-2">
                {reg.informed_consent.languages_required.map((l: string, i: number) => (
                  <span key={i} className="text-xs bg-blue-50 text-blue-700 px-2 py-1 rounded">{l}</span>
                ))}
              </div>
            </div>
          )}
        ...
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-5">
          <div className="flex items-start justify-between gap-3 mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="font-bold text-blue-900 text-lg">Principal Investigator</h4>
                {personnel.principal_investigator.time_commitment && (
                  <p className="text-sm text-blue-700">Time: {personnel.principal_investigator.time_commitment}</p>
                )}
              </div>
            </div>
          ...
          {personnel.principal_investigator.qualifications_required?.length > 0 && (
            <div className="mb-3">
              <span className="text-xs font-medium text-blue-700 uppercase block mb-2">Qualifications Required</span>
              <ul className="space-y-1">
          ...
          {personnel.principal_investigator.responsibilities?.length > 0 && (
            <div className="mb-3">
              <span className="text-xs font-medium text-blue-700 uppercase block mb-2">Responsibilities</span>
              <div className="flex flex-wrap gap-2">
                {personnel.principal_investigator.responsibilities.map((r: string, i: number) => (
                  <span key={i} className="text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded">{r}</span>
                ))}
              </div>
            </div>
          )}
          {personnel.principal_investigator.delegation_restrictions?.length > 0 && (
            <div className="mb-3">
              <span className="text-xs font-medium text-blue-700 uppercase block mb-2">Delegation Restrictions</span>
              <ul className="space-y-1">
          ...
          <SourceTextSnippet
            ...
            className="bg-blue-50/50 border-blue-300"
          />
        </div>
      )}
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {training.gcp_training.required !== undefined && (
              <div className="p-3 bg-blue-50 rounded-lg">
                <span className="text-xs font-medium text-blue-700 uppercase block mb-1">Required</span>
                <span className="font-medium text-blue-900">{training.gcp_training.required ? "Yes" : "No"}</span>
              </div>
            )}
            ...
            {training.gcp_training.certification_required !== undefined && (
              <div className="p-3 bg-blue-50 rounded-lg">
                <span className="text-xs font-medium text-blue-700 uppercase block mb-1">Certification</span>
                <span className="font-medium text-blue-900">{training.gcp_training.certification_required ? "Required" : "Not Required"}</span>
              </div>
            )}
          </div>
                ...
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      {t.certification_required && <span className="text-xs bg-amber-100 text-amber-700 px-2 py-0.5 rounded">Certification Required</span>}
                      {t.renewal_period && (
      ...
      <div className="bg-gradient-to-br from-indigo-50 to-purple-50 border border-indigo-200 rounded-2xl p-5">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="font-bold text-indigo-900 text-lg">Site Activation Timeline</h4>
              <p className="text-sm text-indigo-700">Key milestones for site activation</p>
            </div>
          </div>
            ...
            return (
              <div key={key} className="flex items-start gap-4">
                <div className="flex flex-col items-center">
                  ...
                  {idx < phases.length - 1 && <div className="w-0.5 h-8 bg-indigo-200 mt-2" />}
                </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {supply.packaging_labeling.blinding_requirements && (
              <div className="p-3 bg-purple-50 rounded-lg">
                <span className="text-xs font-medium text-purple-700 uppercase block mb-1">Blinding</span>
                <span className="font-medium text-purple-900">
                  <EditableText
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {supply.storage_distribution.storage_temperature && (
              <div className="p-3 bg-blue-50 rounded-lg">
                <span className="text-xs font-medium text-blue-700 uppercase block mb-1">Storage Temp</span>
                <span className="font-medium text-blue-900">
                  <EditableText
      ...
      {tech.edc_system && (
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h4 className="font-bold text-blue-900 text-lg">EDC System</h4>
              {tech.edc_system.vendor_name && (
                <p className="text-sm text-blue-700">{tech.edc_system.vendor_name}</p>
              )}
            </div>
          </div>
          {tech.edc_system.system_capabilities?.length > 0 && (
            <div className="mb-3">
              <span className="text-xs font-medium text-blue-700 uppercase block mb-2">Capabilities</span>
              <div className="flex flex-wrap gap-2">
                {tech.edc_system.system_capabilities.map((c: string, i: number) => (
                  <span key={i} className="text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded">{c.replace(/_/g, " ")}</span>
                ))}
              </div>
            </div>
          )}
          ...
          {tech.iwrs_rtsm.functions?.length > 0 && (
            <div className="flex flex-wrap gap-2">
              {tech.iwrs_rtsm.functions.map((f: string, i: number) => (
                <span key={i} className="text-xs bg-purple-50 text-purple-700 px-2 py-1 rounded">{f}</span>
              ))}
            </div>
          )}
