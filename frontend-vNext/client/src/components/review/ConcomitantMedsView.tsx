        ...
        <div className="mt-3 p-2 bg-gray-50 rounded-lg border border-gray-200">
          ...
          <div className="flex flex-wrap gap-2 text-xs">
            {med.biomedicalConcept.code && (
              <span className="bg-white px-2 py-1 rounded border border-gray-200">Code: {med.biomedicalConcept.code}</span>
            )}
            {med.biomedicalConcept.decode && (
              <span className="bg-white px-2 py-1 rounded border border-gray-200">{med.biomedicalConcept.decode}</span>
            )}
          </div>
        </div>
      )}
  ...
  return (
    <div className="bg-gray-50 rounded-xl p-4 border border-gray-200" data-testid={`rescue-med-${med.id}`}>
      ...
      {med.impact_on_endpoints && (
        <div className="mt-3 p-2 bg-gray-50 rounded-lg border border-gray-200">
          <span className="text-xs font-medium text-gray-700 uppercase tracking-wider block mb-1">Impact on Endpoints</span>
        ...
        <div className="mt-3">
          ...
          <div className="flex flex-wrap gap-2">
            {interaction.affected_drugs.map((drug: any, drugIdx: number) => (
              <span key={drugIdx} className="text-xs px-2.5 py-1 rounded-full bg-gray-50 text-gray-800 border border-gray-200">
                <EditableText
        ...
        <div className="mt-3 p-2 bg-gray-50 rounded-lg border border-gray-200">
          ...
          <div className="flex flex-wrap gap-2 text-xs">
            {interaction.biomedicalConcept.code && (
              <span className="bg-white px-2 py-1 rounded border border-gray-200">Code: {interaction.biomedicalConcept.code}</span>
            )}
            {interaction.biomedicalConcept.decode && (
              <span className="bg-white px-2 py-1 rounded border border-gray-200">{interaction.biomedicalConcept.decode}</span>
            )}
          </div>
        </div>
      )}
