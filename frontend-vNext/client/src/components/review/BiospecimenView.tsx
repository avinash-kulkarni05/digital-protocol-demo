      ...
      {data.central_laboratory && (
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-2xl p-5 shadow-sm">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center flex-shrink-0 shadow-md">
  ...
  return (
    <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm" data-testid={`specimen-${specimen.id}`}>
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          {purposeDisplay && (
            <span className="text-xs bg-blue-50 text-blue-700 rounded-full px-2.5 py-1 border border-blue-200">
              {purposeDisplay}
            </span>
          )}
        ...
        <div className="mt-3 p-2 bg-purple-50 rounded-lg border border-purple-200">
          ...
          <div className="flex flex-wrap gap-2 text-xs">
            ...
            {specimen.biomedicalConcept.codeSystem && (
              <span className="bg-white px-2 py-1 rounded border border-purple-200 text-gray-500">
                {specimen.biomedicalConcept.codeSystem}
              </span>
            )}
          </div>
        ...
        <div key={item.schedule_id || idx} className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            {item.fasting_required !== undefined && (
              <div className="bg-gray-50 rounded-lg p-2">
                ...
                <span className={cn("text-sm font-medium", item.fasting_required ? "text-amber-600" : "text-gray-900")}>
          ...
          {item.special_conditions && (
            <div className="mt-3 p-2 bg-blue-50 rounded-lg border border-blue-200">
              <span className="text-xs font-medium text-blue-700 uppercase tracking-wider block mb-1">Special Conditions</span>
        ...
        <div key={item.processing_id || idx} className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {item.step_order && (
                  <span className="ml-2 text-xs bg-orange-50 text-orange-700 px-2 py-0.5 rounded-full border border-orange-200">
          ...
          {(item.aliquot_count || item.aliquot_volume || item.aliquot_container) && (
            <div className="mt-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
              <span className="text-xs font-medium text-blue-700 uppercase tracking-wider block mb-2">Aliquot Settings</span>
              <div className="grid grid-cols-3 gap-3">
                {item.aliquot_count && (
                  <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {storage.storage_phase && (
                  <span className="ml-2 text-xs bg-cyan-50 text-cyan-700 px-2 py-0.5 rounded-full border border-cyan-200">
          ...
          <div className="mt-4">
            ...
            <div className="flex flex-wrap gap-2">
              {kitSpecs.kit_components.map((component: string, idx: number) => (
                <span key={idx} className="px-3 py-1 bg-amber-50 text-amber-800 text-sm rounded-full border border-amber-200">
                  {component}
                </span>
              ))}
            </div>
        ...
        <div className="space-y-4">
          ...
          {qualityReqs.quality_metrics && (
            <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
              <span className="text-xs font-medium text-blue-700 uppercase tracking-wider block mb-1">Quality Metrics</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            {regulatoryReqs.genetic_consent && (
              <div className="p-3 bg-purple-50 rounded-lg border border-purple-200">
                <span className="text-xs font-medium text-purple-700 uppercase tracking-wider block mb-1">Genetic Consent</span>
                <p className="text-sm text-gray-900">{regulatoryReqs.genetic_consent}</p>
              </div>
            )}
            {regulatoryReqs.future_use_consent && (
              <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
                <span className="text-xs font-medium text-blue-700 uppercase tracking-wider block mb-1">Future Use Consent</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {regulatoryReqs.retention_period && (
              <div className="p-3 bg-amber-50 rounded-lg border border-amber-200">
                <span className="text-xs font-medium text-amber-700 uppercase tracking-wider block mb-1">Retention Period</span>
