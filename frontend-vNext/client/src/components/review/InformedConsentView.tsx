            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {procedure.is_optional && (
                  <span className="text-xs bg-gray-100 text-gray-700 px-2 py-0.5 rounded mt-1 inline-block">Optional</span>
                )}
              </div>
            </div>
...
function SpecialConsentCard({
  ...
  if (typeof consent === 'string') {
    return (
      <div className="bg-white/70 rounded-lg p-4 border border-gray-200">
        <span className="text-xs font-medium text-gray-700 uppercase block mb-2">{title}</span>
        <p className="text-sm text-gray-900">{consent}</p>
      </div>
    );
  }
  ...
  if (typeof consent === 'boolean') {
    return (
      <div className="bg-white/70 rounded-lg p-4 border border-gray-200">
        <span className="text-xs font-medium text-gray-700 uppercase block mb-2">{title}</span>
        <p className="text-sm text-gray-900">{consent ? 'Yes' : 'No'}</p>
      </div>
    );
  }
    ...
    <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        {consent.separate_consent !== undefined && (
          <span className="text-[10px] font-medium px-2 py-1 rounded-full bg-gray-100 text-gray-700 border border-gray-200">
      ...
      {resultsDisclosure && (
        <div className="mt-3 pt-3 border-t border-gray-100">
          <span className="text-xs font-medium text-gray-600 block mb-1">Results Disclosure</span>
      ...
      {consent.retention_period && (
        <div className="mt-2">
          <span className="text-xs font-medium text-gray-600 block mb-1">Retention Period</span>
      ...
      {consent.withdrawal_process && (
        <div className="mt-2">
          <span className="text-xs font-medium text-gray-600 block mb-1">Withdrawal</span>
        ...
        <div className="bg-gradient-to-br from-gray-50 to-gray-50 border border-gray-200 rounded-2xl p-5">
          <div className="flex items-start justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <h4 className="font-bold text-gray-900 text-lg">Confidentiality</h4>
            </div>
          ...
          <div className="space-y-3">
            {confidentiality.privacy_protections && (
              <div className="bg-white/70 rounded-lg p-3 border border-gray-200">
                <span className="text-xs font-medium text-gray-700 uppercase block mb-1">Privacy Protections</span>
                <span className="text-sm text-gray-900">{renderValue(confidentiality.privacy_protections)}</span>
              </div>
            )}
            {confidentiality.data_retention && (
              <div className="bg-white/70 rounded-lg p-3 border border-gray-200">
                <span className="text-xs font-medium text-gray-700 uppercase block mb-1">Data Retention</span>
                <span className="text-sm text-gray-900">{renderValue(confidentiality.data_retention)}</span>
              </div>
            )}
            {confidentiality.data_use_restrictions && (
              <div className="bg-white/70 rounded-lg p-3 border border-gray-200">
                <span className="text-xs font-medium text-gray-700 uppercase block mb-1">Data Use Restrictions</span>
                <span className="text-sm text-gray-900">{renderValue(confidentiality.data_use_restrictions)}</span>
              </div>
            )}
          </div>
        </div>
